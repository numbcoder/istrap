 ...
 *    I.js 0.1.0
 *    (c) 2011 ihaveu.com
 *    I may be freely distributed under the MIT license.
 *    For all details and documentation:
 *    http://documentcloud.github.com/backbone
 */
var I = (function(window, $, undefined){
  ...
  */
  var support = {
    // check wheither support pushState
    pushState: history.pushState ? true : false,

    // check wheither support hashchange
  ...
  I.Model = function(attributes, options){
    ...
    this._changed = false;
    //this._previousAttributes = _extend({}, this.attributes);
      ...
      if(controller && constructor.reLoad === true){
		...
		*/
		...
		cleanHash : function(hash){
			return decodeURI(hash).replace(hashStrip, '');
		},
...
*/
  ...
  */
  I.start = function(defaultHash){
    ...
    this.changePage(hash, { hashchange : hashchange });
  };

	I.Model.extend = I.Controller.extend = I.Router.extend = extend;
	return I;
